### This repository was archived. We will move to [adblock2](https://github.com/Yuki2718/adblock2) repository. Filters/rules that are not in the new repository will no more be maintainerd.
